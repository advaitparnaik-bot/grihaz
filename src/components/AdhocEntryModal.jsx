...
export default function AdhocEntryModal({ homeId, onClose, onAdded }) {
  ...
  function getContractDayRate(staffMember) {
    ...
    if (staffMember.pay_type === 'fixed_monthly')
      return staffMember.monthly_rate ? Math.round(staffMember.monthly_rate / 26) : null
    return null
  }
  ...
  return (
    <>
        ...
        <div className="modal-sheet">
          ...
          <div className="modal-body">
            ...
            <div className="form-field">
              ...
              <input
                type="text"
                placeholder="e.g. Cleaned balcony windows, Extra cooking day"
            ...
            <div className="form-field">
              ...
              <div className="adhoc-toggle-row">
                ...
                <button
                  ...
                  onClick={() => {
                    set('has_payment', false)
                    setForm(p => ({ ...p, payment_type: '', custom_amount: '', settlement: '', settlement_mode: '' }))
                  }}>No</button>
              </div>
                  ...
                  <div className="pay-type-options">
                    <button
                      ...
                      <span className="pt-hint">
                        {contractRate
                          ? `₹${contractRate?.toLocaleString('en-IN')} per day`
                          : 'No rate on file (per visit staff)'}
                      </span>
                    </button>
                    <button
                      type="button"
      ...
      {/* AddStaffModal rendered via portal so it always sits above this modal,
          regardless of CSS bundle order on staging */}
